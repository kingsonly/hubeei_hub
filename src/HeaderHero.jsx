        ...
        <div className=" bg-no-repeat  w-[100%] h-[90vh] flex items-center " style={cardStyle}>
            <div className="ml-[200px]  h-[70%] w-[100%] mt-[] ">
                ...
                <div className="flex justify-between w-[270px] ">
                    <div className="flex items-center justify-center h-[50px] cursor-pointer rounded text-[] text-[16px] font-bold w-[100px] h-[50px] cursor-pointer bg-[#DCD427] text-[red]   " style={buttonStyle} >
