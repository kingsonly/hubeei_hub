...
const Cards = ({ title, imageUrl, id, handleClose, handleOpen, liked, type = false, Rank }) => {
        ...
        <div className='w-[100%]'>
            {type ?
                <div className='flex  text-[] w-[350px] mb-4 h-[100%]'>
                    ...
                    <div className='w-[70%]'><div onClick={handleCardClick} className={`relative h-[100%] bg-no-repeat group cursor-pointer overflow-hidden transition-transform duration-300 transform hover:scale-105 hover:z-10  mb-4 ml-0`} style={cardStyle}>
                        <div>
                ...
                <div>
                    <div>
                        <div onClick={handleCardClick} className={`relative h-[200px] bg-no-repeat  border  w-[300px] group cursor-pointer overflow-hidden transition-transform duration-300 transform hover:scale-105 hover:z-10 border-fuchsia-800  border-2 border-blue mb-4`} style={cardStyle}>
                            <div>
